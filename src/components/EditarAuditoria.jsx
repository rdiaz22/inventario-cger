...
const EditarAuditoria = ({ audit, isOpen, onClose, onUpdated }) => {
  ...
  useEffect(() => {
    if (isOpen && audit) {
      ...
      setFormData({
        ...
        start_date: audit.start_date ? audit.start_date.split('T')[0] : '',
        end_date: audit.end_date ? audit.end_date.split('T')[0] : '',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-semibold text-gray-900">Editar Auditoría</h2>
          <button
            onClick={onClose}
